...
<div id="main" class="scroll-container company">
	...
	<section class="section2">
		<div class="block-container">
			<div class="h3" class="display-5" style="padding-top: 50px">어제보다
			...
			<div class="contianer">
				...
				<div style="padding-top: 600px">
					<div class="area_cont">
						<strong class="subject_corp">LKH</strong>
						<h4 class="desc_info">
	...
	<section class="section3">
		<div class="block-container">
			<div>
				<div class="display-3" style="padding-top: 100px">Our Misson &
					Vision</div>
				<div class="vision">
					<img src="/resources/images/main_s_3_1.jpg" />
					<p>
						명확한 권한과 책임을 가지고<br>일에 몰입합니다.
					</p>
				</div>
				<div class="vision">
					<img src="/resources/images/main_s_3_1.jpg" />
					<p>
						빠른 실행을 위해, 정보 및 의사결정<br>과정을 공개 공유합니다.
					</p>
				</div>
				<div class="vision">
					<img src="/resources/images/main_s_3_1.jpg" />
					<p>
						최선의 의사결정을 위해<br>무엇이든 솔직하게 의견을 냅니다.
					</p>
				</div>
