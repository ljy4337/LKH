						...
						<div class="row featurette" style="margin-top: 30px;">
							...
							<div class="col-md-7 ">
								<h2 class="featurette-heading ">
									Join LKH . <span class="text-muted">채용안내</span>
								</h2>
								</br>
							</div>
						</div>
						<img src="/resources/images/rc2.png"
			...
			<section class="section4">
				<div class="block-container">
					<div class="row featurette">
						...
						<div class="col-md-7 ">
							<h2 class="featurette-heading ">
								Join LKH . <span class="text-muted">직무소개</span>
							</h2>
							</br>
						</div>
					</div>
					<div class="container">
						...
						<a data-toggle="collapse" data-target="#demo1"
							...
							style="width: 100px; height: 100px;">IT
						</a> <a data-toggle="collapse" data-target="#demo2"
							style="margin-right: 100px;"> <img
							src="/resources/images/testicon.png"
							style="width: 100px; height: 100px;">TEST
						</a> <a data-toggle="collapse" data-target="#demo3"> <img
							src="/resources/images/saleicon.png"
							style="width: 100px; height: 100px;">SALE
						</a>
					</div>
